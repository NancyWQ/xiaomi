...
<HeaderBackComponent title="购物车"></HeaderBackComponent>
<div class="scroll-box gouwu-view">
      <div class="shop-wrap" v-if="shopCarListLength == 0">
        <router-link to="/">
        <img src="../../assets/icon/empty-car.png" alt="">
        </router-link>
      </div>
          ...
          <div class="function-box fr">
            ...
            <div class="button-group">
              <div class="function-button">
                <span class="btn jia iconfont icon-jia"></span>
                <span class="number">{{ target.length }}</span>
                <span class="btn jian iconfont icon-jian" ></span>
              </div>

              <span class="delete iconfont icon-del"></span>
            </div>
          </div>
        </div>
